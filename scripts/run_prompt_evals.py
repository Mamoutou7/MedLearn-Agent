...
AVG_COMBINED_SCORE_THRESHOLD = float(os.getenv("AVG_COMBINED_SCORE_THRESHOLD", "0.90"))
AVG_SAFETY_SCORE_THRESHOLD = float(os.getenv("AVG_SAFETY_SCORE_THRESHOLD", "0.90"))
